...
public interface SysYParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterConstVar(SysYParser.ConstVarContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ConstVar}
	 * labeled alternative in {@link SysYParser#constInitVal}.
	 * @param ctx the parse tree
	 */
	void exitConstVar(SysYParser.ConstVarContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ConstArray}
	 * labeled alternative in {@link SysYParser#constInitVal}.
	 * @param ctx the parse tree
	 */
	void enterConstArray(SysYParser.ConstArrayContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ConstArray}
	 * labeled alternative in {@link SysYParser#constInitVal}.
	 * @param ctx the parse tree
	 */
	void exitConstArray(SysYParser.ConstArrayContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code VarInitVal}
	 * labeled alternative in {@link SysYParser#initVal}.
	 * @param ctx the parse tree
	 */
	void enterVarInitVal(SysYParser.VarInitValContext ctx);
	/**
	 * Exit a parse tree produced by the {@code VarInitVal}
	 * labeled alternative in {@link SysYParser#initVal}.
	 * @param ctx the parse tree
	 */
	void exitVarInitVal(SysYParser.VarInitValContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAsignStmt(SysYParser.AsignStmtContext ctx);
	/**
	 * Exit a parse tree produced by the {@code asignStmt}
	 * labeled alternative in {@link SysYParser#stmt}.
	 * @param ctx the parse tree
	 */
	void exitAsignStmt(SysYParser.AsignStmtContext ctx);
	/**
