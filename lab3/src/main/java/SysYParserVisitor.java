...
public interface SysYParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitConstVar(SysYParser.ConstVarContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitConstArray(SysYParser.ConstArrayContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code VarInitVal}
	 * labeled alternative in {@link SysYParser#initVal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarInitVal(SysYParser.VarInitValContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code asignStmt}
	 * labeled alternative in {@link SysYParser#stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsignStmt(SysYParser.AsignStmtContext ctx);
	/**
